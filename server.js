...
const app = express();
const AdministratorModel = require('./model/administrator.model')
app.use(cors());

const administrators = [];

const patients = [
    {id : "1011", name : 'Roshan', dob: new Date(1997,6,11), gender : "male", place : 'anjansingi', bloodGroup : "O+", height : "168", weight : "60"}
]
